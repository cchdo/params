...
note=None,
warning='This parameter currently lacks the centroid angle in the name for backwards compatibility. We may update this in the future and provide an alias.\n\nThis parameter is the backscattering function (Beta) it is NOT the backscattering coefficient due to particles commonly called Bbp',
error_name=None,
cf_unit='m-1 sr-1',
reference_scale=None,
whp_number=None,
