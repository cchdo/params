...
whp_number=None,
scope='sample',
analytical_temperature_name='LAB_DEN_TMP',
analytical_temperature_units='DEG C',
rank=146.0,
radiation_wavelength=None,
scattering_angle=None,
...
in_erddap=True,
whp_unit='UMOL/L',
nc_name='dissolved_organic_carbon_l',
flag_w='woce_discrete',
cf_name=None,
numeric_min=None,
numeric_max=None,
...
in_erddap=True,
whp_unit='UMOL/L',
nc_name='total_dissolved_nitrogen_l',
flag_w='woce_discrete',
cf_name=None,
numeric_min=None,
numeric_max=None,
...
WHPNameDC(
whp_name='LAB_DEN_TMP',
dtype='decimal',
in_erddap=False,
whp_unit='DEG C',
nc_name='density_temperature',
flag_w='woce_discrete',
cf_name='temperature_of_analysis_of_sea_water',
numeric_min=None,
numeric_max=None,
numeric_precision=3,
field_width=9,
description='The temperature at which the density of a water sample was physically measured',
note=None,
warning=None,
error_name=None,
cf_unit='degC',
...
nc_name='ctd_cdom_ru',
flag_w='woce_ctd',
cf_name='concentration_of_colored_dissolved_organic_matter_in_sea_water',
numeric_min=None,
numeric_max=None,
numeric_precision=4,
field_width=9,
...
('DOC_NASA', 'UMOL/L'): ('DOC', 'UMOL/L'),
('SAMPLING_RATE', None): ('SAMPLING_RATE', 'HZ'),
}
